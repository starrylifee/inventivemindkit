...
st.markdown("""
    ## 🚀 시작하기
    왼쪽의 탐색 바를 사용하여 원하는 도구를 선택하고 사용해 보세요.
    > 표시를 누르면 인공지능 도구 리스트가 나옵니다.
""")

# 구글 폼 링크 추가
st.markdown("""
    ## 📝 인공지능 수업 도구 의뢰
    특별한 인공지능 수업 도구가 필요하신가요?
    직접 제작해드리겠습니다. [이곳을 클릭](https://forms.gle/HC8ePNYhQzoX2Mio9)하여 구글 폼에 접속해 주세요.
