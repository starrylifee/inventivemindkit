...
if st.button("인공지능아 문제상황 생성해줘"):
    # 프롬프트 구성
    prompt_parts = f"학생이 발명아이디어를 결정했습니다. {title}이라는 이름을 가진 발명품은 {ideas}입니다. 학생의 발명 아이디어를 듣고 평가해주세요. 창의성 30점, 효율성 30점, 현실성 40점으로 총 100점으로 평가해주세요. 평가는 깐깐하게 해주시고, 점수를 낮게 주면서 엄하게 평가해주세요. "
